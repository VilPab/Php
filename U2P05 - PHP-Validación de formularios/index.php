...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, "UTF-8"); ?> " method="post">
    ...
    Fecha de nacimiento:<input type="date" name="fecha" value="<?php echo $fecha ;?>" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" required / ><?php if(!$errorF){echo" <a estilos='color:red;'>La fecha tiene que tener un formato dd/mm/aaaa y tiene que ser valida</a>"; $errorF=true;}?><br>
    Contraseña:<input type="password" name="pass" pattern="[A-Za-z0-9!?-]{1,12}" value="<?php echo $pass ;?>" /><?php if(!$errorP){echo"<a estilos='color:red;'> La contraseña tiene que tener de 8 a 12 caracteres <a>"; $errorP=true;}?><br>
